import { GET_DATA_DONE, GET_DATA_REQUESTED, GET_DATA_FAILED, GET_POKEMON, ADD_TO_FAVORITES, DELETE_FAV_POKEMON, FILTER_POKEMON_LIST } from '../constants';
...
export const filterPokemon = createAction(FILTER_POKEMON_LIST,
    payload => payload
);
